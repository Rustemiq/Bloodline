...
enemies1 = [
    (ShotgunInHand(target="player"), [8, 3], (2, 2)),
...
enemies2 = [
    (UziInHand(target="player"), [2, 2], (1, 1)),
...
enemies3 = [
    (UziInHand(target="player"), [4, 6], (0, 0)),
...
enemies4 = [
    (ShotgunInHand(target="player"), [6, 7], (3, 2)),
...
enemies5 = [
    (ShotgunInHand(target="player"), [8, 3], (0, 0)),
...
enemies6 = [
    (UziInHand(target="player"), [4, 10], (0, 0)),
...
enemies7 = [
    (UziInHand(target="player"), [6, 18], (3, 0)),
